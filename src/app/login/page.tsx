...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Tangkap error dari hook untuk ditampilkan di UI
  ...
  const handleGoogleLogin = () => {
    // Arahkan user ke endpoint Google di backend
        ...
        <div className="card p-8 mb-6">
          ...
          >
            <svg className="w-5 h-5" viewBox="0 0 48 48">
              ...
              <path fill="#4285F4" d="M46.98 24.55c0-1.57-.15-3.09-.42-4.55H24v8.51h12.8c-.59 2.73-2.18 4.96-4.66 6.55l7.58 5.85c4.61-4.25 7.28-10.3 7.28-17.36z"></path>
              <path fill="#FBBC05" d="M10.53 28.59c-.49-1.45-.76-2.99-.76-4.59s.27-3.14.76-4.59l-7.98-6.19C.92 16.46 0 20.12 0 24s.92 7.54 2.56 10.78l7.97-6.19z"></path>
              <path fill="#34A853" d="M24 48c6.48 0 11.93-2.13 15.89-5.81l-7.58-5.85c-2.18 1.45-4.96 2.3-8.31 2.3-6.26 0-11.57-4.22-13.47-9.91l-7.98 6.19C6.51 42.62 14.62 48 24 48z"></path>
